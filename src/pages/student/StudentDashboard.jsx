...
export default function StudentApplications() {
  ...
  const openApp = useCallback(
    (app) => {
      ...
      // fetch only pushed announcements
      const qNotes = query(
      ...
      const unsub = onSnapshot(
        ...
        (snap) => {
          ...
          items.sort(
            (a, b) =>
              (toDate(b.pushedAt || b.createdAt)?.getTime() || 0) -
              (toDate(a.pushedAt || a.createdAt)?.getTime() || 0)
          );
          setNotes(items);
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal app-modal" onClick={(e) => e.stopPropagation()}>
            <div className="appm-head">
              <div>
                <h2 className="appm-title">
                  {selectedApp.job?.title || "Job"}
                </h2>
                <div className="appm-sub">
                  ...
                  {notes.map((n) => (
                    <div className="timeline-item" key={n.id}>
                      ...
                      <div className="timeline-content">
                        {n.message && (
                          <div className="timeline-text">{n.message}</div>
                        )}
